...
if flavor_choice == 1 or flavor_choice == 3:
    ...
    os.system("systemctl stop BedrockServerManager")
    print("service stopped")
    print("unregistering the service...")
    os.system("systemctl disable BedrockServerManager")
    print("unregistered service")
    print("deleting the service file...")
    os.remove("/etc/systemd/system/BedrockServerManager.service")
